...
const HomePageEvents = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center min-h-[50vh] bg-background-color">
  ...
  if (isError) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[50vh] space-y-6 bg-background-color">
        ...
        >
          <IoRefreshOutline className="mr-2 h-5 w-5 transition-transform duration-200 group-hover:scale-110" />
          Retry Loading
        </button>
      </div>
    );
  ...
  return (
    <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-background-color overflow-hidden">
              ...
              >
                <div className="aspect-w-16 aspect-h-9 relative">
                  {event.img ? (
                    ...
                    <div className="flex items-center justify-center h-48 bg-background-alt-color">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center text-sm text-text-alt-color">
                      <IoCalendarOutline className="w-4 h-4 mr-2 text-link-color" />
                      <span>
                    ...
                    <div className="flex items-center text-sm text-text-alt-color">
                      <IoTimeOutline className="w-4 h-4 mr-2 text-link-color" />
                      <span>
                    ...
                    <div className="flex items-center text-sm text-text-alt-color">
                      <IoLocationOutline className="w-4 h-4 mr-2 text-link-color" />

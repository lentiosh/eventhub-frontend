...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-background-color/80 backdrop-blur-lg border-b border-border-alt-color">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              ...
              className="flex items-center px-4 py-2 rounded-xl text-text-color hover:bg-background-alt-color transition-all duration-200"
            >
              <IoCalendarOutline className="w-5 h-5 mr-3" />
            ...
            {isAuthenticated && user.is_staff && (
              <Link
                ...
                className="flex items-center px-4 py-2 rounded-xl text-text-color hover:bg-background-alt-color transition-all duration-200"
              >
                <IoGridOutline className="w-5 h-5 mr-3" />
            ...
            {isAuthenticated ? (
              <div className="flex items-center ml-4 space-x-4">
                ...
                <div className="flex items-center space-x-2 px-3 py-1 rounded-xl bg-background-alt-color">
                  <IoPersonCircleOutline className="w-5 h-5 text-text-color" />
      ...
      {isOpen && (
        <div className="md:hidden bg-background-color/95 backdrop-blur-lg border-t border-border-alt-color">
          <div className="px-4 pt-2 pb-4 space-y-2">
            ...
            {isAuthenticated ? (
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center px-4 py-2 rounded-xl bg-background-alt-color">
                  <IoPersonCircleOutline className="w-5 h-5 text-text-color mr-3" />
